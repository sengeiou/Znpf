...
export class MemberApi{
    ...
    addguwen(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/addguwen',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    addjingjiren(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/addjingjiren',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,

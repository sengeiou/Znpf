...
import { InstApi } from '../../apis/premises.api';
...
export class PremisesApi{
    ...
    entranceinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/entranceinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    guwenlist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/guwenlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    quxiao(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/quxiao',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    shoucang(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/shoucang',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    shoucangguwen(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/shoucangguwen',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    shoucanglist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/shoucanglist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    gallerytype(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'premises/gallerytype',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,

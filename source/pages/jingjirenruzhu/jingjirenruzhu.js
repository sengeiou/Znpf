...
class Content extends AppBase {
  ...
  jingjigongsiFn(e) {
    this.Base.setMyData({
      jingjigongsi: e.detail.value
    })
  }
  memdianFn(e) {
    this.Base.setMyData({
      mendian: e.detail.value
    })
  }
  bindpic(e) {
  ...
  tijiao() {
    ...
    var mendian = this.Base.getMyData().mendian;
...
body.memdianFn = content.memdianFn;
body.jingjigongsiFn = content.jingjigongsiFn;
Page(body)